...
class SymptomsIntensityPage extends StatefulWidget {
  final String? jsonData;

  const SymptomsIntensityPage({Key? key, required this.jsonData}) : super(key: key);
  factory SymptomsIntensityPage.async({required Key key, required String? jsonData}) {

    return SymptomsIntensityPage(
        key: key,
        jsonData: jsonData
    );
  }
  ...
  @override
  _SymptomsIntensityPageState createState() => _SymptomsIntensityPageState();
}

class _SymptomsIntensityPageState extends State<SymptomsIntensityPage> {
  ...
  Future<File> _loadHtmlFromAssets() async {
    ...
    String fileText = await rootBundle.loadString('assets/vega_lite4.html');
  ...
  //     {"headacheEntryid": 22, "symptom": "nausea"},
  //     {"headacheEntryid": 15, "symptom": "sensitivity to light"},
  //     {"headacheEntryid": 42, "symptom": "weakness"},
  //     {"headacheEntryid": 37, "symptom": "vomiting"},
  //     {"headacheEntryid": 59, "symptom": "nausea"},
  //     {"headacheEntryid": 67, "symptom": "sensitivity to light"},
  //     {"headacheEntryid": 89, "symptom": "weakness"},
  //     {"headacheEntryid": 10, "symptom": "vomiting"},
  //     {"headacheEntryid": 25, "symptom": "nausea"},
  //     {"headacheEntryid": 33, "symptom": "sensitivity to light"},
  //     {"headacheEntryid": 48, "symptom": "weakness"},
  //     {"headacheEntryid": 73, "symptom": "vomiting"},
  //     {"headacheEntryid": 55, "symptom": "nausea"},
  //     {"headacheEntryid": 77, "symptom": "sensitivity to light"},
  //     {"headacheEntryid": 84, "symptom": "weakness"},
  //     {"headacheEntryid": 90, "symptom": "vomiting"},
  //     {"headacheEntryid": 14, "symptom": "nausea"},
  //     {"headacheEntryid": 28, "symptom": "sensitivity to light"},
  //     {"headacheEntryid": 63, "symptom": "weakness"},
  //     {"headacheEntryid": 51, "symptom": "vomiting"}
  //   ];
  //
  //
  //
  //   List<Map<String, dynamic>> combinedData = [...data1, ...data2];
  //
  //
  //   Map<int, Map<String, dynamic>> groupedData = {};
  //
  //   for (var entry in combinedData) {
  //     int id = entry['headacheEntryid'];
  //
  //     if (groupedData.containsKey(id)) {
  //
  //       groupedData[id]?.addAll({'symptom': entry['symptom']});
  //     } else {
  //       groupedData[id] = entry;
  //     }
  //   }
  //
  //   return jsonEncode(groupedData.values.toList());
  // }
